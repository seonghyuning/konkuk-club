 ...
 * 운영진 회의
 */
class ClubManagerChatActivity : AppCompatActivity() {
    lateinit var binding: ActivityMessageBinding
    private lateinit var auth: FirebaseAuth
    private lateinit var database: DatabaseReference
    private lateinit var clubId: String
    private lateinit var name: String //현재 user의 이름
    ...
    private fun initLayout() {
        ...
        binding.messageTitle.text = "운영진 회의"
        ...
        binding.sendBtn.setOnClickListener {
            ...
            database.child("clubManagerChat").child(clubId).push().setValue(
    ...
    private fun initData() {
        ...
        //메세지 정보 불러오기
        database.child("clubManagerChat").child(clubId)
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
